    ...
    <div class=" mx-auto h-screen flex flex-col">
        <div class="navbar bg-gradient-to-r from-sky-400 to-blue-300 flex justify-between items-center py-10 px-6">
            <div class="flex space-x-2 items-center justify-center">
                ...
                <h1 class="text-4xl font-extrabold text-center text-gray-800 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-amber-600">Company Dashboard</h1>
            </div>
        ...
        <div class="flex mt-3">
            <div class="drawer lg:drawer-open">
                ...
                <div class="drawer-content flex flex-col">
                    ...
                    <div class="card shadow-lg m-4 bg-amber-200">
                        <div class="card-body">
                            @yield('content')
                        </div>
                    </div>
                ...
                <div class="drawer-side">
                    ...
                    <ul class="menu bg-orange-100 rounded-xl ms-4 p-4 w-72">
                        <p class="badge badge-warning my-3">Post Management</p>
                        <li><a href="{{ url('employer/post') }}" class="hover:text-primary">Posts</a></li>
                        <li><a href="{{ url('employer/category') }}" class="hover:text-primary">Categories</a></li>
                        <hr/>
                        <li><a href="{{route('employer.application.index')}}" class="hover:text-primary">Applications</a></li>
                        <li><a href="{{ route('employer.payment.index') }}" class="hover:text-primary">Payments</a></li>
                    </ul>
                </div>
            </div>
        </div>
